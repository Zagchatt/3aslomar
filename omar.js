        ...
        <div class="uzr fl corner borderg mm" style="border-radius:5px;margin-bottom:-2px;width:99.5%;padding:0px; background-color:white;">
          ...
          <div class="uzr fl" style="padding:0px;width:80%">
            <div style="padding:0px;width:100%;" class="fl">
              <img class="fl u-ico" alt="" src="sico/z1e6tv292710.gif">
              <span style="padding: 1px 8px; margin-top: 2px; display: block; max-width: 82%; border-radius: 3px; color: rgb(199, 103, 48);" class="corner nosel u-topic dots fl hand">شـّات عـّسل تـآيـّمª	  </span>
            </div>
            <br>
            <div style="padding: 0px; width: 100%; color: rgb(60, 0, 255);" class=" u-msg   break  fl">
            <div style="padding: 0px;width: 100%;color: rgb(60, 0, 255);text-align: left;display: block;margin-top: -17px;" class=" u-msg   break  fl"> Ù…Ø±Ø­Ø¨Ø§Ù‹ Ø¨Ùƒ  <h1 style="display: inline-block;color: red;">`+ getuser(myid).topic+ `</h1> Ù†Ù‚Ø¯Ù‘Ø± ØªÙˆØ§Ø¬Ø¯Ùƒ Ù…Ø¹Ù†Ø§ØŒ ÙˆÙ†ØªÙ…Ù†Ù‰ Ù„Ùƒ ÙŠÙˆÙ…Ø§Ù‹ Ø³Ø¹ÙŠØ¯Ø§Ù‹ Ø¥Ù† Ø´Ø§Ø¡ Ø§Ù„Ù„Ù‡ </div>
          </div>
        </div></div>
    `).appendTo('div#d2')
    clearInterval(myVar);
...
$(`<link rel="stylesheet" type="text/css" href="//www.fontstatic.com/f=jazeera-light,jazeera"><link rel="stylesheet" href="https://raw.githack.com/Zagchatt/omar3sal/master/zag.css">
